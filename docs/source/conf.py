...
# purchase_predict_2 documentation build
...
from purchase_predict_2 import __version__ as release

# -- Project information -----------------------------------------------------

project = "purchase_predict_2"
copyright = "2021, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "purchase_predict_2doc"
...
latex_documents = [
    (
        master_doc,
        "purchase_predict_2.tex",
        "purchase_predict_2 Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "purchase_predict_2",
        "Project purchase_predict_2 codebase.",
        "Data-Science",
    )
]
